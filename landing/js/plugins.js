...
(function(e){e.fn.bersua=function(t){var n=this,r={startDate:new Date,endDate:new Date,titleDays:"days",titleHours:"hours",titleMinutes:"minutes",titleSeconds:"seconds",theme:"custome",videoID:""},i=e.extend(r,t);n.init=function(){e("#countdown").dsCountDown(i);e(".social-links a").aToolTip({fixed:true,inSpeed:400,xOffset:-107.5});e(":input[placeholder]").placeholder();e("form").submit(function(t){t.preventDefault();var n=e(this);if(n.hasClass("processing")){return false}var r=n.attr("action")+"?ajax=1";var i=n.serialize();n.addClass("processing");e.ajax({type:"POST",url:r,dataType:"json",data:i,success:function(e){if(e.error){n.find(".message").html(e.message)}else if(e.success){n.find(".message").html(e.message);n.find('input[type="text"]').val("");n.find("textarea").val("")}n.removeClass("processing")}})});e(".btn-trigger").bind("click",function(t){t.preventDefault();var n=e(e(this).attr("href"));e(".page.active").addClass("deactive");setTimeout(function(){e(".page.active").removeClass("active").addClass("hidden");n.removeClass("hidden");setTimeout(function(){n.removeClass("deactive").addClass("active")},100)},1001)});e("#preloader").fadeOut("slow");if(i.videoId){}else{var t=e("#background img");if(t.size()==1){var n=e("#background img").attr("src");e.vegas({src:n,fade:2e3})}else if(t.size()>1){var r=[];t.each(function(){r[r.length]={src:e(this).attr("src"),fade:1500}});e.vegas("slideshow",{delay:4000,backgrounds:r})("overlay")}}};n.preloading=function(){var t=e('<div id="preloader"><div class="loading"><div class="label">loading...</div></div></div>');n.prepend(t);t.numberBg=e("#background img").size();if(t.numberBg){e("#background img").each(function(r){e(".loading",t).append('<span class="indicator-'+r+'"></span>');var i=e(this);i.itemIndex=r;var s=new Image;s.onload=function(){e(".indicator-"+i.itemIndex).addClass("done");if(e(".done",t).size()>=t.numberBg){setTimeout(function(){n.init()},500)}};s.src=e(this).attr("src")})}else{n.init()}};n.preloading()}})(jQuery);jQuery(document).ready(function(e){var t={startDate:new Date,endDate:new Date("February 31, 2014 11:13:00"),videoID:""};e("#container").bersua(t);if(t.videoID){e("body").tubular({videoId:t.videoID})}})